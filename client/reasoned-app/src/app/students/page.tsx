                ...
                <div className=" mb-5 mx-60 px-10 py-10">
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="character-card" style={{ marginRight: '30px', textAlign: 'center' }}>
                            <img src="/MannyCharacterTransparentBG.png" width="160" height="180" />
                            <br />
                            <p className="text-white font-bold">Straw Manny</p>
                        ...
                        {/* Hasty Harry */}
                        <div className="character-card" style={{ marginRight: '30px', textAlign: 'center' }}>
                            <img src="/HarryCharacterTransparentBG.png" width="160" height="180" />
                            <br />
                            <p className="text-white font-bold">Hasty Harry</p>
                            <p className="text-white">
                        ...
                        <div className="character-card" style={{ marginRight: '30px', textAlign: 'center' }}>
                            ...
                            <br />
                            <p className="text-white font-bold">Slippery Slope Sadie</p>
                            <p className="text-white">
