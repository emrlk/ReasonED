...
export default function ProblemPage() {
    return (
        <>
            ...
            {/**Page Body */}
            <div className="constainer bg-orange h-screen mx-auto py-8">
                <h2 className="text-3xl text-purple font-bold mb-6">Problem</h2>
                ...
                <p className="text-purple mb-6">
                    ...
                    <ol className="text-purple list-decimal ml-8 mb-4">
                        <li>Reusable in a way that still builds on fallacy identification skills</li>
                        <li>Curated for multiple grade levels ranging from elementary to high school.</li>
                        <li>Quick for educators to set up and easy to guide students through.</li>
                    </ol>
