...
// Client-side page to allow teachers to view their home page
const TeacherPage = () => {
            ...
            >
                ...
                <div className="font-bold text-white text-xl flex flex-col gap-1/2">
                    ...
                    <div className="w-60 mb-5">
                        <a href="/teacher-games/teacher-elementary" className="elementaryGames">
                    ...
                    <div className="w-60 mb-5">
                        <a href="/teacher-games/teacher-middle" className="middleSchoolGames">
                    ...
                    <div className="w-60 mb-5">
                        <a href="/teacher-games/teacher-high" className="highSchoolGames">
                    ...
                    <div className="w-60">
                        <a href="/teacher-games/teacher-college" className="collegeGames">
